...
iface eth1.20 inet static
  ...
  post-up ip route add 172.16.0.0/12 via 172.16.20.2
  pre-down iptables -t nat -F
  pre-down iptables -F
  pre-down ip route del 172.16.0.0/12 via 172.16.20.2
EOF
...
# Configure Lighttpd
echo "<H1>You are being routed through ISP-02</H1>" >> /var/www/index.html
